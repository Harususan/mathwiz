...
export default function ModifiedEuler() {
 ...
 // const isVisible = mode !== "select" ? true : false;
  ...
  const [rows, setRows] = useState([
    { key: 1, one: null, two: null, three: null },
    { key: 2, one: null, two: null, three: null },
    { key: 3, one: null, two: null, three: null },
    { key: 4, one: null, two: null, three: null },
  ]);
  ...
  const apiCall = () => {
    ...
    if (
      ...
      fetch("/api/modifiedEulers/runtable", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
                    ...
                    <Table aria-label="simple table">
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell align="center">y<sub>p</sub></TableCell>
                          <TableCell align="center">y<sub>c</sub></TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                        {rows.map((row) => (
